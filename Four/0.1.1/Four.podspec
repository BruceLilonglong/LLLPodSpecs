#
# Be sure to run `pod lib lint Four.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  s.description      = "use four"

  s.homepage         = "https://github.com/BruceLilonglong/Four"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "lilonglong" => "596927598@qq.com" }
  s.source           = { :git => "https://github.com/BruceLilonglong/Four.git", :tag => s.version.to_s }
      ...
      s.subspec spec[:spec_name] do |ss|
          ...
          if spec[:sub_dependency]
              spec[:sub_dependency].each do |dep|
                  ss.dependency "Four/#{dep[:spec_name]}"
              end
          end
      end
  end
